jQuery.fn.extend({
    calendar: function(c) {
        ...
        k += "      <a class='prevMonth'><i></i></a><span class='t_date'><span class='currentYearText'><a class='currentYear'>" + e + "</a>\u5e74</span><span class='currentMonthText'><a class='currentMonth'>" + (f + 1) + "</a>\u6708</span></span><a class='nextMonth'><i></i></a>";
        k += "    </div>";
        ...
        function() {
            if ($("#" + c.controlId + ":hidden").length != 0) {
                ...
                var a = $("#" + c.controlId),
                b = F(n[0]),
                d = b.x + Number(n.offset().left)-1,
                jj = n.offset().left - 43 + n.width()/2;
                if($(document).width()<=340){
                    $('.arrow').css('left',jj+20);
                }else{
                    $('.arrow').css('left',jj);
                }
                b = Number(n.offset().top) + Number(n.outerHeight())+8;
                d = $("#" + c.controlId).width();
                a.css({
                    'top': b + "px",
                    'left': '42px'
